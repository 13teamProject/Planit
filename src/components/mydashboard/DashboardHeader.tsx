export default function DashBoardHeader() {
  return (
    <>
      <nav className="z-998 right-0 top-0 flex h-70 w-full items-center justify-between border-1 border-l-0 border-b-gray-200 bg-white py-25 ps-24 md:pe-40 md:ps-40 lg:pe-80 lg:ps-40">
