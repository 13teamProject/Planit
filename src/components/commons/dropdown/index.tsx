...
export default function DropDownSelectBox({
  ...
  const dropdownClasses = classNames(
    'dark:text-white dark:bg-gray-600 mt-1 flex flex-col gap-1 rounded-b-xl rounded-t-xl border bg-white p-6 text-center sm:right-0',
    {
  ...
  const buttonClasses = classNames(
    'dark:hover:text-white rounded-4 pt-3 hover:bg-toss-blue-light/40 hover:text-toss-blue',
    {
