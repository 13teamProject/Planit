...
export default function BarButton({
  ...
  const className = classNames(
    'w-full flex justify-center items-center text-black-800 border border-gray-200 gap-8 font-bold  hover:border-gray-400 bg-white dark:border-white dark:bg-gray-700 dark:text-white',
    {
